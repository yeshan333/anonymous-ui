    ...
    <Typography>
      ...
      <Paragraph>
        ...
        <Row>
          ...
          <Col span={12}><Progress percent={11} showInfo={false} status="active" /></Col>
          <Col span={4}>{BFM_Persents_of_Right_Arm} %</Col>
        </Row>
        <Row>
          <Col span={4}>左上肢</Col>
          <Col span={4}>{BFM_of_Left_Arm} kg</Col>
          <Col span={12}><Progress percent={44} showInfo={false} status="active" /></Col>
          <Col span={4}>{BFM_Persents_of_Left_Arm} %</Col>
        </Row>
        <Row>
          <Col span={4}>躯干</Col>
          <Col span={4}>{BFM_of_Trunk} kg</Col>
          <Col span={12}><Progress percent={65} showInfo={false} status="active" /></Col>
          <Col span={4}>{BFM_Persents_of_Trunk} %</Col>
        </Row>
        <Row>
          <Col span={4}>右下肢</Col>
          <Col span={4}>{BFM_of_Right_Leg} kg</Col>
          <Col span={12}><Progress percent={55} showInfo={false} status="active" /></Col>
          <Col span={4}>{BFM_Persents_of_Right_Leg} %</Col>
        </Row>
        <Row>
          <Col span={4}>左下肢</Col>
          <Col span={4}>{BFM_of_Left_Leg} kg</Col>
          <Col span={12}><Progress percent={100} showInfo={false} status="active" /></Col>
