...
const MuscleBalance = ({dispatch, singlerecords}: {dispatch: any, singlerecords: SingleRecords}) => {
    ...
    const data = [
        ...
        },
        {
          ...
          address: `${FFM_of_Left_Leg}（${Lower_Limit_FFM_of_Left_Leg} - ${Upper_Limit_FFM_of_Right_Leg}）`,
          percent: FFM_Persents_of_Left_Leg,
        },
        {
          key: '5',
          project: '右下肢（kg）',
          value: calculateBarValue(FFM_Persents_of_Right_Leg, Lower_Limit_FFM_of_Left_Leg, Upper_Limit_FFM_of_Right_Leg),
